            ...
            const j = {
                    ...
                    images: {
                        loadImage: function(e, t, s, a, i, n) {
                            ...
                            function c() { n && n() }
                            d(e).parent("picture")[0] || e.complete && i ? c() : t ? (o = new l.Image, o.onload = c, o.onerror = c, a && (o.sizes = a), s && (o.s RCSet = s), t && (o.src = t)) : c()
                        },
                        preloadImages: function() {
                            ...
                            for (let s = 0; s < e.imagesToLoad.length; s += 1) {
                                ...
                                e.loadImage(a, a.currentSrc || a.getAttribute("src"), a.s RCSet || a.getAttribute("s RCSet"), a.sizes || a.getAttribute("sizes"), !0, t)
                            }
                        }
                    }
                },
